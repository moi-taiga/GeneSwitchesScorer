...
```{r, eval = FALSE}
gs_atlas_r203 <- filter_switchgenes(gs_atlas_glm, allgenes = TRUE,r2cutoff = 0.03)
```


### Optional: view the timeline of the filtered switching genes from the Atlas.
```{r, eval = FALSE}
plot_timeline_ggplot(gs_atlas_r203, timedata = colData(gs_atlas)$Pseudotime, txtsize = 3)
```
